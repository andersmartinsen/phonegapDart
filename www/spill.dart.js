...
["dart.core", "dart:core", , P, {
  ...
  List_List$filled: function($length, fill, $E) {
    var t1, result, i;
    if (typeof $length !== "number" || Math.floor($length) !== $length || false)
...
["", "spill.dart", , M, {
  "^": "",
  main: [function() {
    var t1, ctx, WIDTH, HEIGHT, t2, i, t3;
    t1 = {};
    t1.x_0 = 150;
    t1.y_1 = 150;
    t1.dx_2 = 2;
    ...
    t1.paddlew_9 = null;
    t1.timer_10 = null;
    t1.rightDown_11 = false;
    t1.leftDown_12 = false;
    t1.bricks_13 = null;
    t1.NROWS_14 = null;
    t1.NCOLS_15 = null;
    t1.BRICKWIDTH_16 = null;
    t1.BRICKHEIGHT_17 = null;
    t1.PADDING_18 = null;
    ctx = J.getContext$1$x(document.querySelector("#canvas"), "2d");
    t1.ctx_4 = ctx;
    WIDTH = ctx.canvas.height;
    t1.WIDTH_5 = WIDTH;
    HEIGHT = ctx.canvas.height;
    t1.HEIGHT_6 = HEIGHT;
    J.rect$4$x(ctx, 0, 0, WIDTH, HEIGHT);
    J.set$fillStyle$x(t1.ctx_4, "black");
    J.fill$0$x(t1.ctx_4);
    t2 = t1.WIDTH_5;
    if (typeof t2 !== "number")
      return t2.$div();
    ...
    t1.NROWS_14 = 5;
    t1.NCOLS_15 = 5;
    t1.BRICKWIDTH_16 = t2 / 5 - 1;
    t1.BRICKHEIGHT_17 = 15;
    t1.PADDING_18 = 1;
    t1.bricks_13 = Array(5);
    i = 0;
    while (true) {
      t2 = t1.NROWS_14;
      if (typeof t2 !== "number")
      ...
      if (!(i < t2))
        break;
      t2 = t1.bricks_13;
      t3 = P.List_List$filled(t1.NCOLS_15, 1, P.$int);
      if (i >= t2.length)
        return H.ioore(t2, i);
      t2[i] = t3;
      ++i;
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new M.main_onKeyDown(t1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = H.setRuntimeTypeInfo(new W._EventStream(document, C.EventStreamProvider_keyup._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new M.main_onKeyUp(t1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = new M.main_rect(t1);
    t1.timer_10 = P.Timer_Timer$periodic(C.Duration_10000, new M.main_closure(new M.main_draw(t1, 10, ["#FF1C0A", "#FFFD0A", "#00A308", "#0008DB", "#EB0093"], new M.main_circle(t1), t2, new M.main_clear(t1, t2), new M.main_brickHit(t1))));
  }, "call$0", "main$closure", 0, 0, 1],
  main_onKeyDown: {
    "^": "Closure:2;box_0",
    call$1: function(evt) {
      if (J.get$keyCode$x(evt) === 39)
        this.box_0.rightDown_11 = true;
      else if (evt.keyCode === 37)
        this.box_0.leftDown_12 = true;
    }
  },
  main_onKeyUp: {
    "^": "Closure:2;box_0",
    call$1: function(evt) {
      if (J.get$keyCode$x(evt) === 39)
        this.box_0.rightDown_11 = false;
      else if (evt.keyCode === 37)
        this.box_0.leftDown_12 = false;
    }
  },
  main_circle: {
    "^": "Closure:19;box_0",
    call$3: function(x, y, r) {
      var t1 = this.box_0;
      J.beginPath$0$x(t1.ctx_4);
      J.arc$6$x(t1.ctx_4, x, y, r, 0, 6.283185307179586, true);
      J.set$fillStyle$x(t1.ctx_4, "white");
      J.closePath$0$x(t1.ctx_4);
      J.fill$0$x(t1.ctx_4);
    }
  },
  main_rect: {
    "^": "Closure:20;box_0",
    call$4: function(x, y, w, h) {
      var t1 = this.box_0;
      J.beginPath$0$x(t1.ctx_4);
      J.rect$4$x(t1.ctx_4, x, y, w, h);
      J.closePath$0$x(t1.ctx_4);
      J.fill$0$x(t1.ctx_4);
    }
  },
  main_clear: {
    "^": "Closure:1;box_0,rect_1",
    call$0: function() {
      var t1 = this.box_0;
      J.clearRect$4$x(t1.ctx_4, 0, 0, t1.WIDTH_5, t1.HEIGHT_6);
      this.rect_1.call$4(0, 0, t1.WIDTH_5, t1.HEIGHT_6);
      J.set$fillStyle$x(t1.ctx_4, "black");
      J.fill$0$x(t1.ctx_4);
    }
  },
  main_brickHit: {
    "^": "Closure:5;box_0",
    call$2: function(row, col) {
      var t1, brick;
      t1 = this.box_0.bricks_13;
      if (row < 0 || row >= t1.length)
        return H.ioore(t1, row);
      brick = t1[row];
      if (col < 0 || col >= brick.length)
        return H.ioore(brick, col);
      return brick[col] === 1;
    }
  },
  main_fjernBrick: {
    ...
    call$2: function(row, col) {
      ...
      if (row >>> 0 !== row || row >= t1.length)
        return H.ioore(t1, row);
      brick = t1[row];
      if (col >>> 0 !== col || col >= brick.length)
        return H.ioore(brick, col);
      brick[col] = 0;
    }
  },
  main_draw: {
    "^": "Closure:1;box_0,ballr_2,rowcolors_3,circle_4,rect_5,clear_6,brickHit_7",
    call$0: function() {
      var t1, t2, t3, t4, t5, i, j, t6, t7, rowheight, row, col;
      this.clear_6.call$0();
      t1 = this.box_0;
      this.circle_4.call$3(t1.x_0, t1.y_1, 10);
      if (t1.rightDown_11) {
        t2 = t1.paddlex_7;
        if (typeof t2 !== "number")
          return t2.$add();
        t1.paddlex_7 = t2 + 5;
      } else if (t1.leftDown_12) {
        t2 = t1.paddlex_7;
        if (typeof t2 !== "number")
          return t2.$sub();
        t1.paddlex_7 = t2 - 5;
      ...
      if (typeof t5 !== "number")
        return H.iae(t5);
      t2.call$4(t3, t4 - t5, t1.paddlew_9, t5);
      t3 = this.brickHit_7;
      t4 = this.rowcolors_3;
      i = 0;
      while (true) {
        ...
        while (true) {
          ...
          if (!(j < t5))
            break;
          if (t3.call$2(i, j) === true) {
            t5 = t1.ctx_4;
            if (i >= 5)
              return H.ioore(t4, i);
            J.set$fillStyle$x(t5, t4[i]);
            t5 = t1.BRICKWIDTH_16;
            t6 = t1.PADDING_18;
            if (typeof t5 !== "number")
              return t5.$add();
            if (typeof t6 !== "number")
              return H.iae(t6);
            t7 = t1.BRICKHEIGHT_17;
            if (typeof t7 !== "number")
              return t7.$add();
            t2.call$4(j * (t5 + t6) + t6, i * (t7 + t6) + t6, t5, t7);
          }
          ++j;
        }
        ++i;
      }
      t2 = t1.BRICKHEIGHT_17;
      t4 = t1.PADDING_18;
      if (typeof t2 !== "number")
        return t2.$add();
      if (typeof t4 !== "number")
      ...
      if (typeof t2 !== "number")
        return t2.$add();
      row = C.JSNumber_methods.toInt$0(Math.floor(t1.y_1 / rowheight));
      col = C.JSNumber_methods.toInt$0(Math.floor(t1.x_0 / (t2 + t4)));
      t2 = t1.y_1;
      t4 = t1.NROWS_14;
      if (typeof t4 !== "number")
        return t4.$mul();
      if (t2 < t4 * rowheight && row >= 0 && col >= 0 && t3.call$2(row, col) === true) {
        t1.dy_3 = -t1.dy_3;
        t2 = t1.bricks_13;
      ...
      if (t3 - t5 < 0)
        ...
        if (t3 > t5 - t6) {
          ...
          if (t7) {
            ...
            if (typeof t3 !== "number")
              return t3.$div();
            t1.dx_2 = 8 * ((t2 - (t6 + t3 / 2)) / t3);
            t1.dy_3 = -t4;
          } else if (t3 > t5)
            t1.timer_10.cancel$0();
        }
      }
      t1.x_0 = t1.x_0 + t1.dx_2;
      t1.y_1 = t1.y_1 + t1.dy_3;
    }
  },
  main_closure: {
    "^": "Closure:10;draw_8",
    call$1: function(t) {
      return this.draw_8.call$0();
    }
  }
},
1],
...
{func: "void__dynamic_dynamic_dynamic_dynamic", void: true, args: [null, null, null, null]},
...
//# sourceMappingURL=spill.dart.js.map
//@ sourceMappingURL=spill.dart.js.map
